/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8f229eaea5e4e255d096b0d1478bf08)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	BLOG_ARCHIVE: R2Bucket;
	SITE_MEDIA: R2Bucket;
	BLOG_BACKUPS: R2Bucket;
	CONTENT_DB: D1Database;
	SEARCH_DB: D1Database;
	ASSETS: Fetcher;
	SITE_ORIGIN: "https://blog.ysoseri.us";
	DEFAULT_TIMEZONE: "Pacific/Auckland";
	SESSION_DAYS: "30";
	BACKUP_RETENTION_DAYS: "UNCONFIRMED";
	BLOG_BACKUP_WORKFLOW: Workflow<Parameters<import("./src/worker/index").BlogBackupWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_ORIGIN" | "DEFAULT_TIMEZONE" | "SESSION_DAYS" | "BACKUP_RETENTION_DAYS">> {}
}
